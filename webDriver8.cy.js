...
describe('Webdriver university contact us',function()
   {
       ...
       cy.go('back')
        cy.get('#contact_form > input:nth-child(1)').type('Rajesh').should('be.visible')
        cy.get('#contact_form > input:nth-child(2)').type('Kannan').should('be.visible')
        cy.get('#contact_form > input:nth-child(3)').type('rajeshtest@gmail.com').should('be.visible')
